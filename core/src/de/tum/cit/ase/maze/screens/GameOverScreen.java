...
public class GameOverScreen implements Screen {
    ...
    // making a game over screen based on the menu screen style where character is loaded when he dies fully
    public GameOverScreen(MazeRunnerGame game,int score,float time) {
        ...
        Label gameOverLabel = new Label("GameOver!! YOU SUCK!!", game.getSkin(), "title");
